...
\begin{tikzpicture}
  ...
  \draw[eredge, visible on=<12->] (student) -- node[above,sloped]{\scriptsize\itshape owner} (ownbox.north);
  \draw[eredge, visible on=<12->] (ownbox.east) -- (books);
  ...
  \draw[eredge, visible on=<14->] (student) -- node[above,sloped]{\scriptsize\itshape borrower} (loanbox.north);
  \draw[eredge, visible on=<14->] (loanbox.east) -- (ownbox.west);
  \draw[eredge, visible on=<14->] (loanbox.south) -- (borrow);
  ...
  \cardlabel{(-1.9,7.35)}{(0,n)}{23}{24}   % 7. loan -- Students (borrower)
  \cardlabel{(1.9,7.35)}{(0,n)}{24}{25}    % 8. own -- Students (owner)
