...
\begin{tikzpicture}
  ...
  \draw[eredge, visible on=<12->] (student) -- node[above,sloped,pos=0.25]{\scriptsize\itshape owner} (ownbox.north);
  ...
  \draw[eredge, visible on=<14->] (student) -- node[above,sloped,pos=0.25]{\scriptsize\itshape borrower} (loanbox.north);
